      ...
      softSkills: [
        {
          ...
          description: "Athlete mindset applied to daily execution.",
        },
        {
          title: "Team Collaboration",
          description: "Clear communication and reliable handoffs.",
        },
        {
          title: "Problem Solving",
          description: "Analytical thinking for complex challenges.",
        },
        {
          title: "Adaptability",
          description: "Fast learning across tools and processes.",
        },
      ],
    },
    projects: {
      ...
      items: {
        ...
        smartBanking: {
          title: "Smart Banking",
          description:
            "High-fidelity fintech interface with pixel-perfect execution, advanced responsiveness, and motion-driven interactions.",
        },
        aiAutomation: {
          title: "AI & Automation",
          description:
            "Configured n8n servers, connected messaging APIs, and built AI-driven workflows that automate operations and decision support.",
        },
        aiStudio: {
          title: "AI Studio Gallery",
          description:
            "Curated preview experience for AI-generated social posters, focused on layout consistency and brand-ready presentation.",
        },
      },
    },
    contact: {
      ...
      softSkills: [
        {
          ...
          description: "Mentalidade de atleta aplicada ao dia a dia.",
        },
        {
          title: "Trabalho em Equipe",
          description: "Comunicação clara e colaboração consistente.",
        },
        {
        ...
        },
        {
          ...
          description: "Aprendizado rápido de ferramentas e processos.",
        },
      ],
    },
    projects: {
      ...
      items: {
        ...
        smartBanking: {
          title: "Smart Banking",
          description:
            "Interface fintech de alta fidelidade com execução pixel perfect, responsividade avançada e microanimações.",
        },
        aiAutomation: {
          title: "AI & Automação",
          description:
            "Configuração de servidores n8n, integração com APIs de mensagens e workflows com IA para automatizar operações.",
        },
        aiStudio: {
          title: "AI Studio Gallery",
          description:
            "Prévia curada de pôsteres gerados por IA, com foco em organização visual e consistência de marca.",
        },
      },
    },
    contact: {
